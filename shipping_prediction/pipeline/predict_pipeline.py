...
class PredictPipeline:
    """
    This class predict the shipping price 
    """
    def __init__(self):
        pass
    ...
    def predict(self ,features):
        try:
            ...
            # Assuming you've already imported the necessary libraries and classes
            ...
            new_data = CustomData(
                    ...
                    Unit_of_Measure_Per_Pack=60,
                    Line_Item_Quantity=9073,
                    Pack_Price=2.51,
                    Unit_Price=0.04,
                    First_Line_Designation="Yes",
                    Weight_Kilograms=521.0,
                    Freight_Item_Insurance_USD=49.1,
                    Days_to_Process=239
                 )
...
class CustomData:
    def __init__(self,
        ...
        self.First_Line_Designation = First_Line_Desination
        ...
        self.Freight_Item_Insurance_USD:Freight_Item_Insurance_USD
    ...
    def get_data_as_data_frame(self):
        try:
            custom_data_as_input_dict ={
                ...
                "Freight_Item_Insurance_USD":[self.Freight_Item_Insurance_USD],
